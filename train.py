...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.PROMPTKD_DINO.DINO_MODEL_NAME = "dinov2_vitb14"
    cfg.TRAINER.PROMPTKD_DINO.DINO_CKPT = ""
    cfg.TRAINER.PROMPTKD_DINO.DINO_REPO_OR_DIR = ""
    cfg.TRAINER.PROMPTKD_DINO.DINO_FEATURE_DIM = 768
    ...
    cfg.TRAINER.DINOV2_PRETRAIN.MODEL_NAME = "dinov2_vitb14"
    ...
    cfg.TRAINER.DINOV2_PRETRAIN.FEATURE_DIM = 768
