...
import trainers.promptkd_dino
import trainers.dinov2_pretrain
...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.PROMPTKD_DINO = CN()
    cfg.TRAINER.PROMPTKD_DINO.N_CTX_VISION = 4
    cfg.TRAINER.PROMPTKD_DINO.N_CTX_TEXT = 4
    cfg.TRAINER.PROMPTKD_DINO.CTX_INIT = "a photo of a"
    cfg.TRAINER.PROMPTKD_DINO.PREC = "fp16"
    cfg.TRAINER.PROMPTKD_DINO.PROMPT_DEPTH_VISION = 9
    cfg.TRAINER.PROMPTKD_DINO.PROMPT_DEPTH_TEXT = 9
    cfg.TRAINER.PROMPTKD_DINO.PROJECT_LAYER = 2
    cfg.TRAINER.PROMPTKD_DINO.CE_WEIGHT = 0.0
    cfg.TRAINER.PROMPTKD_DINO.KD_WEIGHT = 1.0
    cfg.TRAINER.PROMPTKD_DINO.TEMPERATURE = 1.0
    cfg.TRAINER.PROMPTKD_DINO.CLIP_TEACHER_NAME = "ViT-L/14"
    cfg.TRAINER.PROMPTKD_DINO.USE_CLIP_TEACHER_CKPT = False
    cfg.TRAINER.PROMPTKD_DINO.DINO_MODEL_NAME = "dinov2_vitl14"
    cfg.TRAINER.PROMPTKD_DINO.DINO_CKPT = ""
    cfg.TRAINER.PROMPTKD_DINO.DINO_REPO_OR_DIR = ""
    cfg.TRAINER.PROMPTKD_DINO.DINO_FEATURE_DIM = 1024
    cfg.TRAINER.PROMPTKD_DINO.DINO_WEIGHT = 2.0
    cfg.TRAINER.PROMPTKD_DINO.DINO_FEAT_WEIGHT = 1.0
    cfg.TRAINER.PROMPTKD_DINO.DINO_REL_WEIGHT = 0.5
    cfg.TRAINER.PROMPTKD_DINO.DINO_TEMPERATURE = 0.07
    cfg.TRAINER.PROMPTKD_DINO.DINO_WARMUP_EPOCH = 5
    cfg.TRAINER.PROMPTKD_DINO.DINO_USE_RELATIONAL_KD = True

    cfg.TRAINER.DINOV2_PRETRAIN = CN()
    cfg.TRAINER.DINOV2_PRETRAIN.MODEL_NAME = "dinov2_vitl14"
    cfg.TRAINER.DINOV2_PRETRAIN.DINO_REPO_OR_DIR = ""
    cfg.TRAINER.DINOV2_PRETRAIN.INIT_CKPT = ""
    cfg.TRAINER.DINOV2_PRETRAIN.SAVE_DIR = "./teacher_model"
    cfg.TRAINER.DINOV2_PRETRAIN.SAVE_NAME = "teacher.pth"
    cfg.TRAINER.DINOV2_PRETRAIN.FEATURE_DIM = 1024
    cfg.TRAINER.DINOV2_PRETRAIN.OUT_DIM = 8192
    cfg.TRAINER.DINOV2_PRETRAIN.MOMENTUM = 0.996
    cfg.TRAINER.DINOV2_PRETRAIN.TEMPERATURE = 0.07
    cfg.TRAINER.DINOV2_PRETRAIN.CENTER_MOMENTUM = 0.9
    cfg.TRAINER.DINOV2_PRETRAIN.PREC = "amp"
    cfg.TRAINER.DINOV2_PRETRAIN.STUDENT_TEMPERATURE = 0.1
    cfg.TRAINER.DINOV2_PRETRAIN.TEACHER_TEMP_WARMUP = 10
